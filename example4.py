import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QLabel, QHBoxLayout, QWidget, QMenu, QAction, QFileDialog, QToolBar, QWidgetAction, QLineEdit, QPushButton, QSplitter, QScrollArea, QVBoxLayout
...
class PdfViewer(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.init_menu_bar()
        self.init_tool_bar()
        self.preview_screen = QScrollArea()
        self.preview_screen.setWidgetResizable(True)
        self.preview_screen.setFocusPolicy(Qt.NoFocus)
        self.preview_screen.setFixedWidth(230)
        self.page_screen = QLabel()

        splitter = QSplitter()
        splitter.addWidget(self.preview_screen)
        splitter.addWidget(self.page_screen)
    ...
    def open_file(self):
        ...
        self.preview_screen.setWidget(widget)
        self.draw_page()
