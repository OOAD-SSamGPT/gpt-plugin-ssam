...
class MainWindow(QMainWindow):
    ...
    def open_file(self):
        ...
        self.preview_screen.draw_preview(self.pdf)
        self.page_screen.set_page(self.pdf[0])
        self.page_screen.draw_page()
    ...
    def previous_button_clicked(self):
        if self.pdf and self.page_num > 0:
            ...
            self.page_screen.set_page(self.pdf[self.page_num])
            self.page_screen.draw_page()
